...
export const COMPUTE_INSTANT_UNSTAKE_DISCRIMINATOR = new Uint8Array([
  172, 220, 51, 183, 2, 94, 253, 251,
]);

export function getComputeInstantUnstakeDiscriminatorBytes() {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    COMPUTE_INSTANT_UNSTAKE_DISCRIMINATOR
  );
}

export type ComputeInstantUnstakeInstruction<
...
export type ComputeInstantUnstakeInstructionData = {
  discriminator: ReadonlyUint8Array;
  validatorListIndex: bigint;
};

export type ComputeInstantUnstakeInstructionDataArgs = {
  validatorListIndex: number | bigint;
};

export function getComputeInstantUnstakeInstructionDataEncoder(): FixedSizeEncoder<ComputeInstantUnstakeInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({
      ...value,
      discriminator: COMPUTE_INSTANT_UNSTAKE_DISCRIMINATOR,
    })
  );
}

export function getComputeInstantUnstakeInstructionDataDecoder(): FixedSizeDecoder<ComputeInstantUnstakeInstructionData> {
...
export function getComputeInstantUnstakeInstructionDataCodec(): FixedSizeCodec<
  ComputeInstantUnstakeInstructionDataArgs,
  ComputeInstantUnstakeInstructionData
> {
  return combineCodec(
    getComputeInstantUnstakeInstructionDataEncoder(),
    getComputeInstantUnstakeInstructionDataDecoder()
  );
}

export type ComputeInstantUnstakeInput<
...
> = {
  ...
  validatorListIndex: ComputeInstantUnstakeInstructionDataArgs['validatorListIndex'];
};

export function getComputeInstantUnstakeInstruction<
  TAccountConfig extends string,
  TAccountStateAccount extends string,
  TAccountValidatorHistory extends string,
  TAccountValidatorList extends string,
...
>(
  input: ComputeInstantUnstakeInput<
    TAccountConfig,
    TAccountStateAccount,
    TAccountValidatorHistory,
    TAccountValidatorList,
...
): ComputeInstantUnstakeInstruction<
  TProgramAddress,
  TAccountConfig,
  TAccountStateAccount,
  TAccountValidatorHistory,
...
> {
  ...
  const instruction = {
    ...
    programAddress,
    data: getComputeInstantUnstakeInstructionDataEncoder().encode(
      args as ComputeInstantUnstakeInstructionDataArgs
    ),
  } as ComputeInstantUnstakeInstruction<
    TProgramAddress,
    TAccountConfig,
    TAccountStateAccount,
    TAccountValidatorHistory,
...
export type ParsedComputeInstantUnstakeInstruction<
  TProgram extends string = typeof STEWARD_PROGRAM_ADDRESS,
...
> = {
  ...
  data: ComputeInstantUnstakeInstructionData;
};

export function parseComputeInstantUnstakeInstruction<
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>
): ParsedComputeInstantUnstakeInstruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getComputeInstantUnstakeInstructionDataDecoder().decode(
      instruction.data
    ),
  };
}
