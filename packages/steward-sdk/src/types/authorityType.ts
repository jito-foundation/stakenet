...
export type AuthorityType =
  ...
  | {
      __kind: 'SetPriorityFeeParameterAuthority';
      setPriorityFeeParameterAuthority: Option<number>;
    };
...
export type AuthorityTypeArgs =
  ...
  | {
      __kind: 'SetPriorityFeeParameterAuthority';
      setPriorityFeeParameterAuthority: OptionOrNullable<number>;
    };
...
export function getAuthorityTypeEncoder(): Encoder<AuthorityTypeArgs> {
  return getDiscriminatedUnionEncoder([
    ...
    [
      'SetPriorityFeeParameterAuthority',
      getStructEncoder([
        ['setPriorityFeeParameterAuthority', getOptionEncoder(getU8Encoder())],
      ]),
    ],
  ]);
}
...
export function getAuthorityTypeDecoder(): Decoder<AuthorityType> {
  return getDiscriminatedUnionDecoder([
    ...
    [
      'SetPriorityFeeParameterAuthority',
      getStructDecoder([
        ['setPriorityFeeParameterAuthority', getOptionDecoder(getU8Decoder())],
      ]),
    ],
  ]);
}
...
>;
export function authorityType(
  kind: 'SetPriorityFeeParameterAuthority',
  data: GetDiscriminatedUnionVariantContent<
    AuthorityTypeArgs,
    '__kind',
    'SetPriorityFeeParameterAuthority'
