...
export type ScoreDetails = {
  ...
  maxPriorityFeeCommission: number;
  /** Epoch of realized priority fee commission */
  maxPriorityFeeCommissionEpoch: number;
};
...
export function getScoreDetailsEncoder(): FixedSizeEncoder<ScoreDetailsArgs> {
  return getStructEncoder([
    ...
    ['maxPriorityFeeCommission', getU16Encoder()],
    ['maxPriorityFeeCommissionEpoch', getU16Encoder()],
  ]);
}
...
export function getScoreDetailsDecoder(): FixedSizeDecoder<ScoreDetails> {
  return getStructDecoder([
    ...
    ['maxPriorityFeeCommission', getU16Decoder()],
    ['maxPriorityFeeCommissionEpoch', getU16Decoder()],
  ]);
}
