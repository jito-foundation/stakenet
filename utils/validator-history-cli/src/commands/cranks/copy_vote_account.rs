...
pub async fn run(args: CrankCopyVoteAccount, client: Arc<RpcClient>) -> anyhow::Result<()> {
    ...
    let validator_histories =
        get_all_validator_history_accounts(&client, args.validator_history_program_id).await?;
