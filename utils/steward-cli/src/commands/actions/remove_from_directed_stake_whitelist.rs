...
#[derive(Parser)]
#[command(about = "Remove from Directed stake whitelist")]
pub struct RemoveFromDirectedStakeWhitelist {
...
pub async fn command_remove_from_directed_stake_whitelist(
    args: RemoveFromDirectedStakeWhitelist,
    ...
    let instruction = Instruction {
        program_id,
        accounts: jito_steward::accounts::RemoveFromDirectedStakeWhitelist {
            config: args.steward_config,
            directed_stake_whitelist,
            authority: authority_pubkey,
        }
        .to_account_metas(None),
        data: jito_steward::instruction::RemoveFromDirectedStakeWhitelist {
            record_type,
            record: args.record,
        }
        .data(),
