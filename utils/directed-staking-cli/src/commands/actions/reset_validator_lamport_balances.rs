...
// };
//
// use crate::commands::command_args::ResetValidatorLamportBalances;
// use stakenet_sdk::utils::{
//     accounts::get_all_steward_accounts,
//     transactions::{configure_instruction, print_base58_tx},
// };
//
// pub async fn command_reset_validator_lamport_balances(
//     args: ResetValidatorLamportBalances,
...
//     let ix = Instruction {
//         program_id,
//         accounts: jito_steward::accounts::ResetValidatorLamportBalances {
//             steward_state: all_steward_accounts.state_address,
//             config: args.permissioned_parameters.steward_config,
//             authority: authority.pubkey(),
//         }
//         .to_account_metas(None),
//         data: jito_steward::instruction::ResetValidatorLamportBalances {}.data(),
//     };
//
